...
void MenuSquareMatrix(){
    while(true){
        ...
        if(type == 0){
            ...
            while (true){
                int function = ChooseFunctionSquareMatrix();  // 1 - sum; 2 - mult scalar and matrix; 3 - mult two matrix; 4 - norm; 5 -Multiplication of scalar and row;
                if (function == 1){
                    cout << "Enter first matrix:" << endl;
                    ...
                    SquareMatrix<int>* MatrixMult = matrix->MultiplyOnScalar(scalar);
                    //cout << "Multiplication of matrix and scalar = " << endl << MatrixMult << endl;
                    IntSquareMatrixPrint(*MatrixMult);
                }
                else if (function == 3){
                    cout << "Enter first matrix:" << endl;
                    auto* matrix1 = InputSquareMatrix<int>();
